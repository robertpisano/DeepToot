# a strategy currently determines both how we will parse ball chasing data for a specific play as well as how the neural net architecture we will feed the data into\
